...
public class Life implements Application.ActivityLifecycleCallbacks {
    private int count = 0;
    private AppLifeListener listener;

    public Life(Application application) {
        if (application == null)
